...
export class Gnosis111__execTransactionFromModuleReturnDataResult {
  value0: boolean;
  value1: Bytes;
...
export class Gnosis111__getModulesPaginatedResult {
...
export class Gnosis111 extends ethereum.SmartContract {
  static bind(address: Address): Gnosis111 {
    return new Gnosis111("Gnosis111", address);
  }
  ...
  execTransactionFromModuleReturnData(
    ...
    data: Bytes,
    operation: i32
  ): Gnosis111__execTransactionFromModuleReturnDataResult {
    let result = super.call(
      "execTransactionFromModuleReturnData",
    ...
    return new Gnosis111__execTransactionFromModuleReturnDataResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_execTransactionFromModuleReturnData(
    ...
    data: Bytes,
    operation: i32
  ): ethereum.CallResult<Gnosis111__execTransactionFromModuleReturnDataResult> {
    let result = super.tryCall(
      "execTransactionFromModuleReturnData",
      "execTransactionFromModuleReturnData(address,uint256,bytes,uint8):(bool,bytes)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Gnosis111__execTransactionFromModuleReturnDataResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
  ...
  getModulesPaginated(
    start: Address,
    pageSize: BigInt
  ): Gnosis111__getModulesPaginatedResult {
    let result = super.call(
      "getModulesPaginated",
    ...
    return new Gnosis111__getModulesPaginatedResult(
  ...
  try_getModulesPaginated(
    start: Address,
    pageSize: BigInt
  ): ethereum.CallResult<Gnosis111__getModulesPaginatedResult> {
    let result = super.tryCall(
      "getModulesPaginated",
      "getModulesPaginated(address,uint256):(address[],address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gnosis111__getModulesPaginatedResult(
