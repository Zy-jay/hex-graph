...
export class HEX__dailyDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class HEX__globalsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class HEX__stakeListsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
...
export class HEX__xfLobbyEntryResult {
  value0: BigInt;
  value1: Address;
...
export class HEX__xfLobbyMembersResult {
  value0: BigInt;
  value1: BigInt;
...
export class HEX extends ethereum.SmartContract {
  static bind(address: Address): HEX {
    return new HEX("HEX", address);
  }
  ...
  dailyData(param0: BigInt): HEX__dailyDataResult {
    let result = super.call(
      "dailyData",
    ...
    return new HEX__dailyDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_dailyData(param0: BigInt): ethereum.CallResult<HEX__dailyDataResult> {
    let result = super.tryCall(
      "dailyData",
      "dailyData(uint256):(uint72,uint72,uint56)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  try_globals(): ethereum.CallResult<HEX__globalsResult> {
    let result = super.tryCall(
      "globals",
      "globals():(uint72,uint72,uint40,uint72,uint16,uint72,uint40,uint128)",
      []
  ...
  stakeLists(param0: Address, param1: BigInt): HEX__stakeListsResult {
    let result = super.call(
      "stakeLists",
    ...
    return new HEX__stakeListsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_stakeLists(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<HEX__stakeListsResult> {
    let result = super.tryCall(
      "stakeLists",
      "stakeLists(address,uint256):(uint40,uint72,uint72,uint16,uint16,uint16,bool)",
      [
  ...
  xfLobbyEntry(memberAddr: Address, entryId: BigInt): HEX__xfLobbyEntryResult {
    let result = super.call(
      "xfLobbyEntry",
    ...
    return new HEX__xfLobbyEntryResult(
      result[0].toBigInt(),
      result[1].toAddress()
    );
  }
  ...
  try_xfLobbyEntry(
    memberAddr: Address,
    entryId: BigInt
  ): ethereum.CallResult<HEX__xfLobbyEntryResult> {
    let result = super.tryCall(
      "xfLobbyEntry",
      "xfLobbyEntry(address,uint256):(uint256,address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HEX__xfLobbyEntryResult(value[0].toBigInt(), value[1].toAddress())
    );
  }

  xfLobbyMembers(param0: BigInt, param1: Address): HEX__xfLobbyMembersResult {
    let result = super.call(
      "xfLobbyMembers",
    ...
    return new HEX__xfLobbyMembersResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_xfLobbyMembers(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<HEX__xfLobbyMembersResult> {
    let result = super.tryCall(
      "xfLobbyMembers",
      "xfLobbyMembers(uint256,address):(uint40,uint40)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new HEX__xfLobbyMembersResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
